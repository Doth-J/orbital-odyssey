...
export default function Portrait({
  ...
  return (
    <div className="portrait">
      <div className="artwork" style={{ width, height }}>
        {children}
      </div>
      <h1 className={`title ${isOpen ? "on" : "off"}`}>{title}</h1>
      <a
        className={`author ${isOpen ? "on" : "off"}`}
        href={link}
        target="_blank"
      >
        <svg height="32px" width="32px" viewBox="0 0 291.32 291.32">
